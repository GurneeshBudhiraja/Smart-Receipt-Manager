...
function FeatureCard({
  ...
  return (
    <div
      className={`bg-white p-6 relative rounded-lg shadow-md flex flex-col justify-between transition-all ease-in-out duration-300 group overflow-clip ${className} `}
    >
      <div className="">
